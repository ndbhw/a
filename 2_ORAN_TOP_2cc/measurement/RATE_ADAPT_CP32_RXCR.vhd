...
entity RATE_ADAPT_CP32_RXCR is
    generic (
...
end RATE_ADAPT_CP32_RXCR;

architecture BEHAVE of RATE_ADAPT_CP32_RXCR is
...
--------------------------------------------------------------------------------
    ...
    begin
        if (CLK'event and CLK = '1') then
            data_fifo_user(0)(MAX_RU_ELEMENT-1 downto 0) <= IN_PE_INDEX;            
        end if;
    end process;
...
--------------------------------------------------------------------------------
    ...
    OUT_PE_INDEX                    <= out_user(MAX_RU_ELEMENT-1 downto 0);    
