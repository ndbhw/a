...
--                                                                            --
-- Function   : MTU buffer extension (O-RAN component)                        --
--                                                                            --
...
architecture BEHAVE of MTU_BUFFER_EXT is
...
--------------------------------------------------------------------------------
    ...
    generic map(
        MEMORY_SIZE                 => 23040                                   ,--: integer := 2048;
        ...
        WRITE_DATA_WIDTH_A          => 9                                       ,--: integer := 32;
        READ_DATA_WIDTH_A           => 9                                       ,--: integer := 32;
        ...
        WRITE_DATA_WIDTH_B          => 18                                      ,--: integer := 32;
        READ_DATA_WIDTH_B           => 18                                      ,--: integer := 32;
        BYTE_WRITE_WIDTH_B          => 18                                      ,--: integer := 32;
    ...
    port map(
        ...
        WEA(0)                      => WEA                                     ,--: in  std_logic_vector((WRITE_DATA_WIDTH_A/BYTE_WRITE_WIDTH_A)-1 downto 0);
